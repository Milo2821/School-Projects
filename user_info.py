...
# Solicitar nombre, apellidos, edad, estatura y peso
...
# Mostrar mensaje con la información recopilada
print(f"Hola {nombre} {apellido_paterno} {apellido_materno}, tu edad es {edad} años, tienes una estatura de {estatura} m. y tu peso es de {peso} kg.")
